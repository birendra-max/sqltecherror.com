...
export default function Swi() {
    ...
    function changeMode(x) {
        if (x == 1) {
            ...
            document.getElementById("body").style.color = "white !important";
            document.getElementById("body").style.transition = "all 1s";
            document.title = 'SqlTecherrorc.com - Dark Mode Enable'
            setInterval(() => {
                document.title = 'SqlTecherrorc.com'
            }, 2000);
            setChecked(true);
        }
        else if (x == 0) {
            ...
            document.title = 'SqlTecherrorc.com - White Mode Enable'
            setInterval(() => {
                document.title = 'SqlTecherrorc.com'
    ...
    return (
        <>
            <div class="pb-10 cursor-pointer group fixed bottom-0 right-0 p-2  flex items-end justify-end w-24 h-24 ">
                {/* <!-- main --> */}
                ...
                <div class="absolute rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-16  flex  p-2 hover:p-3 bg-blue-300 hover:bg-blue-400  text-white">
                    {(checked) ? <svg onClick={() => changeMode(0)} id="dark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-white">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" />
                    </svg> : <svg onClick={() => changeMode(1)} id="white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-white">
