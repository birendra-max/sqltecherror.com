    ...
    <>
      <main className='mt-40'>
        <article className='transition-all duration-300 transform'>
          <header class="mx-auto mt-30 max-w-screen-lg rounded-t-lg bg-white pt-16 text-center shadow-lg ">
          <img class="-z-40 absolute top-0 left-0 -mt-40 h-96 w-full object-cover shadow-sm" src={Defaultimg} alt="" />
